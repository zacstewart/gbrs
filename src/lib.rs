...
macro_rules! decode_op {
    ($op:expr, $this:ident) => {
        match $op {
            ...
            0x03 => $this.inc_bc(),
            0x04 => { let b = $this.register_b(); $this.inc(b) }
            0x05 => { let b = $this.register_b(); $this.dec(b) }
            ...
            0x0b => $this.dec_bc(),
            0x0c => { let c = $this.register_c(); $this.inc(c) }
            0x0d => { let c = $this.register_c(); $this.dec(c) }
            ...
            0x13 => $this.inc_de(),
            0x14 => { let d = $this.register_b(); $this.inc(d) }
            0x15 => { let d = $this.register_b(); $this.dec(d) }
            ...
            0x1b => $this.dec_de(),
            0x1c => { let e = $this.register_e(); $this.inc(e) }
            0x1d => { let e = $this.register_e(); $this.dec(e) }
            ...
            0x23 => $this.inc_hl(),
            0x24 => { let h = $this.register_h(); $this.inc(h) }
            0x25 => { let h = $this.register_h(); $this.dec(h) }
            ...
            0x2b => $this.dec_hl(),
            0x2c => { let l = $this.register_l(); $this.inc(l) }
            0x2d => { let l = $this.register_l(); $this.dec(l) }
            ...
            0x3b => $this.dec_sp(),
            0x3c => { let a = $this.register_a(); $this.inc(a) }
            0x3d => { let a = $this.register_a(); $this.dec(a) }
